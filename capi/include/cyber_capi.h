...
#define CYBER_ABI_VERSION_MINOR 13
...
/* Ceiling on texels generated by one bake. 0 disables it. This is a hard
 * width*height allocation guard; it is not a process RSS estimate. */
