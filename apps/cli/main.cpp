            ...
            {"injectability",
             {
                 ...
                 {"halfLatticeComponents", injectability.halfLatticeComponents},
                 {"halfLatticeAcceptedComponents", injectability.halfLatticeAcceptedComponents},
                 {"halfLatticeAcceptedArcs", injectability.halfLatticeAcceptedArcs},
                 {"halfLatticeInjectedComponents", injectability.halfLatticeInjectedComponents},
                 {"halfLatticeInjectedArcs", injectability.halfLatticeInjectedArcs},
                 {"halfLatticeProjectedComponents", injectability.halfLatticeProjectedComponents},
                 {"halfLatticeProjectedArcs", injectability.halfLatticeProjectedArcs},
                 {"halfLatticeGuidedProjectedComponents",
                  injectability.halfLatticeGuidedProjectedComponents},
                 {"halfLatticeGuidedProjectedArcs", injectability.halfLatticeGuidedProjectedArcs},
                 {"halfLatticeRejectedDependencies", injectability.halfLatticeRejectedDependencies},
                 {"halfLatticeRejectedParity", injectability.halfLatticeRejectedParity},
                 ...
                 {"halfLatticeRejectedUnderdetermined",
                  injectability.halfLatticeRejectedUnderdetermined},
                 {"halfLatticeIsolatedAfterExclusion",
                  injectability.halfLatticeIsolatedAfterExclusion},
                 {"halfLatticeBlockedByExcludedOwnership",
